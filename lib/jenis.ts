...
export const JENIS_SEED: JenisPengeluaran[] = [
  ...
  { id: 5,  nama: 'Buku',                     icon: '📚', color: '#0369A1' },
  { id: 6,  nama: 'Fashion',                  icon: '👗', color: '#8B5CF6' },
  { id: 7,  nama: 'Invest',                   icon: '📈', color: '#10B981' },
  { id: 8,  nama: 'Jajan',                    icon: '🍿', color: '#F97316' },
  { id: 9,  nama: 'Keperluan apart',          icon: '🏠', color: '#3B82F6' },
  { id: 10, nama: 'Keperluan Rumah',          icon: '🏡', color: '#06B6D4' },
  { id: 11, nama: 'Kesehatan',                icon: '💊', color: '#14B8A6' },
  { id: 12, nama: 'Kirim ke rumah',           icon: '📦', color: '#84CC16' },
  { id: 13, nama: 'Kirim ke ade',             icon: '💌', color: '#F43F5E' },
  { id: 14, nama: 'Kopi',                     icon: '☕', color: '#92400E' },
  { id: 15, nama: 'Lain-lain',                icon: '✨', color: '#A3A3A3' },
  { id: 16, nama: 'Laundry',                  icon: '👕', color: '#818CF8' },
  { id: 17, nama: 'Maen / hobi',              icon: '🎮', color: '#A855F7' },
  { id: 18, nama: 'Makan / Minum',            icon: '🍜', color: '#EF4444' },
  { id: 19, nama: 'Paket data & emoney',      icon: '📱', color: '#0EA5E9' },
  { id: 20, nama: 'Parkir',                   icon: '🅿️', color: '#64748B' },
  { id: 21, nama: 'Perkakas',                 icon: '🔧', color: '#B45309' },
  { id: 22, nama: 'Servis & keperluan motor', icon: '🏍️', color: '#DC2626' },
  { id: 23, nama: 'Transportasi',             icon: '🚌', color: '#0284C7' },
]
